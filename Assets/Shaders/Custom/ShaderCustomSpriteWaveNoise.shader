	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				fixed4 noiseColor = tex2D(_NoiseTex, IN.texcoord);
				fixed noise = noiseColor.r * _NoiseScale;
				...
				distFromSource += (1-beyondWaveFront) * noise;
				...
				c.rgb += ceil(waveAlpha) * _WaveColor.rgb;
