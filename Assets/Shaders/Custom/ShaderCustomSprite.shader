	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				//if( IN.objectSpaceX > 0.0 )
				//{
				//	c = fixed4( IN.objectSpaceX * c.a, IN.objectSpaceX * c.a, IN.objectSpaceX * c.a, c.a );
				//}
				//else
				//{
				//	c.rgb *= c.a;
