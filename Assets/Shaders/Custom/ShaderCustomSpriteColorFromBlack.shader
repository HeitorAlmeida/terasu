Shader "Custom/SpriteColorFromBlack"
{
	...
	Properties
	{
        ...
        _NewColor ("Black To", Color) = (1.0, 1.0, 1.0, 1.0)
	}
	SubShader
	{
		Tags
		...
		Pass
		{
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				fixed greyscale = (c.r + c.g + c.b) / 3.0;
				c.rgb = ( (greyscale * c.rgb) + ((1-greyscale) * _NewColor.rgb) );
